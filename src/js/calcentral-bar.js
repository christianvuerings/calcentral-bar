(function(){
  ...
  var addNav = function() {
    ...
    for (var i = 0; i < topLinks.length; i++) {
      ...
      var aText = document.createTextNode(item.textContent);
      a.appendChild(aText);
      addLinkEvent(a);
      li.appendChild(a);
      ul.appendChild(li);
  ...
  var addContainer = function() {
    topPeopleSoftContainer.parentNode.appendChild(topContainer);
  };
